...
st.subheader("Step 3.")
st.write("Check accuracy and edit the form accordingly *Note that innacuracies may be caused by illegible handwriting* If you don't take medication everyday replace :unselected: fileds with nan to insure accuracy.")
st.subheader("Step 4")
