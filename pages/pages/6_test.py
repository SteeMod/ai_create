...
with st.form("Review"):
    ...
    if latest_blob is not None:
        ...
        if data is not None:
            ...
            Day1Dosage = Day1Dosage.text_input("Day1Dosage", value=str(row_data.get('Day1Dosage', '')))
            Day1Freq = Day1Freq.text_input("Day1Frequency", value=str(row_data.get('Day1Freq', '')))
            Day1Form = Day1Form.text_input("Day1Form", value=str(row_data.get('Day1Form', '')))
            Day1Route = Day1Route.text_input("Day1Route", value=str(row_data.get('Day1Route', '')))
