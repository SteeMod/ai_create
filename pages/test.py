...
def download_blob_data(blob):
    try:
        blob_client = blob_service_client.get_blob_client(blob.container, blob.name)
        stream = io.BytesIO()
...
with st.form("Review"):
    ...
    if submitted:
        ...
        if data is not None:
            ...
            Day4Form = Day4Form.text_input("Form_4", value=str(row_data.get('Day4Form', '')))
            Day4Route = Day4Route.text_input("Route_4", value=str(row_data.get('Day4Route', '')))
            ...
            if st.form_submit_button('Submit'):
                form_data = pd.DataFrame({
                    ...
                    'Day10yes': [Day10yes],
                    'Day10No': [Day10No],
                    'Day10Dosage': [Day10Dosage],
                    'Day10Freq': [Day10Freq],
                    'Day10Form': [Day10Form],
                    'Day10Route': [Day10Route],

                    'Day11': [Day11],
                    'Day11Yes': [Day11Yes],
                    'Day11No': [Day11No],
                    'Day11Dosage': [Day11Dosage],
                    'Day11Freq': [Day11Freq],
                    'Day11Form': [Day11Form],
                    'Day11Route': [Day11Route], 

                    'Day12': [Day12],
                    'Day12Yes': [Day12Yes],
                    'Day12No': [Day12No],
                    'Day12Dosage': [Day12Dosage],
                    'Day12Freq': [Day12Freq],
                    'Day12Form': [Day12Form],
                    'Day12Route': [Day12Route],

                    'Day13': [Day13],
                    'Day13Yes': [Day13Yes],
                    'Day13No': [Day13No],
                    'Day13Dosage': [Day13Dosage],
                    'Day13Freq': [Day13Freq],
                    'Day13Form': [Day13Form],
                    'Day13Route': [Day13Route],    

                    'Day14': [Day14],
                    'Day14Yes': [Day14Yes],
                    'Day14No': [Day14No],
                    'Day14Dosage': [Day14Dosage],
                    'Day14Freq': [Day14Freq],
                    'Day14Form': [Day14Form],
                    'Day14Route': [Day14Route],

                    'Day15': [Day15],
                    'Day15Yes': [Day15Yes],
                    'Day15No': [Day15No],
                    'Day15Dosage': [Day15Dosage],
                    'Day15Freq': [Day15Freq],
                    'Day15Form': [Day15Form],
                    'Day15Route': [Day15Route],  

                    'Day16': [Day16],
                    'Day16Yes': [Day16Yes],
                    'Day16No': [Day16No],
                    'Day16Dosage': [Day16Dosage],
                    'Day16Freq': [Day16Freq],
                    'Day16Form': [Day16Form],
                    'Day16Route': [Day16Route],

                    'Day17': [Day17],
                    'Day17Yes': [Day17Yes],
                    'Day17No': [Day17No],
                    'Day17Dosage': [Day17Dosage],
                    'Day17Freq': [Day17Freq],
                    'Day17Form': [Day17Form],
                    'Day17Route': [Day17Route],

                    'Day18': [Day18],
                    'Day18Yes': [Day18Yes],
                    'Day18No': [Day18No],
                    'Day18Dosage': [Day18Dosage],
                    'Day18Freq': [Day18Freq],
                    'Day18Form': [Day18Form],
                    'Day18Route': [Day18Route],

                    'Day19': [Day19],
                    'Day19Yes': [Day19Yes],
                    'Day19No': [Day19No],
                    'Day19Dosage': [Day19Dosage],
                    'Day19Freq': [Day19Freq],
                    'Day19Form': [Day19Form],
                    'Day19Route': [Day19Route],     

                    'Day20': [Day20],
                    'Day20Yes': [Day20Yes],
                    'Day20No': [Day20No],
                    'Day20Dosage': [Day20Dosage],
                    'Day20Freq': [Day20Freq],
                    'Day20Form': [Day20Form],
                    'Day20Route': [Day20Route],

                    'Day21': [Day21],
                    'Day21Yes': [Day21Yes],
                    'Day21No': [Day21No],
                    'Day21Dosage': [Day21Dosage],
                    'Day21Freq': [Day21Freq],
                    'Day21Form': [Day21Form],
                    'Day21Route': [Day21Route],    

                    'Day22': [Day22],
                    'Day22Yes': [Day22Yes],
                    'Day22No': [Day22No],
                    'Day22Dosage': [Day22Dosage],
                    'Day22Freq': [Day22Freq],
                    'Day22Form': [Day22Form],
                    'Day22Route': [Day22Route],

                    'Day23': [Day23],
                    'Day23Yes': [Day23Yes],
                    'Day23No': [Day23No],
                    'Day23Dosage': [Day23Dosage],
                    'Day23Freq': [Day23Freq],
                    'Day23Form': [Day23Form],
                    'Day23Route': [Day23Route],

                    'Day24': [Day24],
                    'Day24Yes': [Day24Yes],
                    'Day24No': [Day24No],
                    'Day24Dosage': [Day24Dosage],
                    'Day24Freq': [Day24Freq],
                    'Day24Form': [Day24Form],
                    'Day24Route': [Day24Route],

                    'Day25': [Day25],
                    'Day25Yes': [Day25Yes],
                    'Day25No': [Day25No],
                    'Day25Dosage': [Day25Dosage],
                    'Day25Freq': [Day25Freq],
                    'Day25Form': [Day25Form],
                    'Day25Route': [Day25Route],

                    'Day26': [Day26],
            		'Day26Yes': [Day26Yes],
            		'Day26No': [Day26No],
            		'Day26Dosage': [Day26Dosage],
            		'Day26Freq': [Day26Freq],
            		'Day26Form': [Day26Form],
            		'Day26Route': [Day26Route], 

                    'Day27': [Day27],
            		'Day27Yes': [Day27Yes],
            		'Day27No': [Day27No],
            		'Day27Dosage': [Day27Dosage],
            		'Day27Freq': [Day27Freq],
            		'Day27Form': [Day27Form],
            		'Day27Route': [Day27Route],

                    'Day28': [Day28],
            		'Day28Yes': [Day28Yes],
            		'Day28No': [Day28No],
            		'Day28Dosage': [Day28Dosage],
            		'Day28Freq': [Day28Freq],
            		'Day28Form': [Day28Form],
            		'Day28Route': [Day28Route],

                    'Day29': [Day29],
            		'Day29Yes': [Day29Yes],
            		'Day29No': [Day29No],
            		'Day29Dosage': [Day29Dosage],
            		'Day29Freq': [Day29Freq],
            		'Day29Form': [Day29Form],
            		'Day29Route': [Day29Route],    
